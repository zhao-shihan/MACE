...
public:
    SpectrometerSD(const G4String& SDName, const G4String& hitsCollectionName, const std::shared_ptr<const Geometry::Entity::Fast::SpectrometerCells>& spectrometerCellEntity);
...
inline auto MACE::SimMACE::SD::SpectrometerSD::FindMonitoring(ObserverPtr<const G4Track> track) {
