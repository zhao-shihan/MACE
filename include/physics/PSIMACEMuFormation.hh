#ifndef   PSIMACEMuFormation_h
#define   PSIMACEMuFormation_h 1
...
/*! PSIMACEMuFormation class defines the muonium formation process in the Carbon foil
...
class PSIMACEMuFormation : public G4VDiscreteProcess {
private:
...
public:
    PSIMACEMuFormation(const G4String& name = "MuFormation", G4ProcessType aType = fElectromagnetic);
    ~PSIMACEMuFormation();
