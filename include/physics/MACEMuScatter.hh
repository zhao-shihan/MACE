...
/* MACEMuScatter class defines the Muonium scattering process. It implements a very
...
#ifndef MACEMuScatter_h
#define MACEMuScatter_h 1

#include "G4VDiscreteProcess.hh"

class MACEMuScatter : public G4VDiscreteProcess {
private:
    G4ParticleChange* const fParticleChange;

public:
    MACEMuScatter(const G4String& name = "MuScatter", G4ProcessType aType = fGeneral);
    ~MACEMuScatter();
