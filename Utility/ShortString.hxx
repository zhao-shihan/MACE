...
public:
    ...
    constexpr ShortString() noexcept : fString{ '\0' } {}
    constexpr ShortString(const ShortString& rhs) noexcept : ShortString(rhs.fString) {}
    ...
    constexpr ShortString(char ch) noexcept : fString{ ch ,'\0' } {}
