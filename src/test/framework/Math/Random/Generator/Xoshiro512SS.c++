...
int main() {
    ...
    for (int i = 0; i < 1000; ++i) { std::ranges::shuffle(arr16, xoshiro512SS); }
    stopWatch = {};
    for (int i = 0; i < 1'000'000; ++i) { std::ranges::shuffle(arr16, xoshiro512SS); }
    time = stopWatch.MillisecondsElapsed();
    ...
    for (int i = 0; i < 100; ++i) { std::ranges::shuffle(arr4096, xoshiro512SS); }
    stopWatch = {};
    for (int i = 0; i < 10'000; ++i) { std::ranges::shuffle(arr4096, xoshiro512SS); }
    time = stopWatch.MillisecondsElapsed();
