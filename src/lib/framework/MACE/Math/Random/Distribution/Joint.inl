...
template<typename ADerived, typename AParameter, typename T, typename... Ds>
    requires(sizeof...(Ds) >= 2 and Concept::NumericVectorAny<T, sizeof...(Ds)>)
MACE_STRONG_INLINE constexpr auto JointInterface<ADerived, AParameter, T, Ds...>::operator()(UniformRandomBitGenerator auto& g) -> T {
...
template<typename ADerived, typename AParameter, typename T, typename... Ds>
    requires(sizeof...(Ds) >= 2 and Concept::NumericVectorAny<T, sizeof...(Ds)>)
MACE_STRONG_INLINE constexpr auto JointInterface<ADerived, AParameter, T, Ds...>::operator()(UniformRandomBitGenerator auto& g, const AParameter& p) -> T {
