    ...
    MACE_ALWAYS_INLINE constexpr auto RA##N##Log##b(T x) noexcept {                    \
        if constexpr (std::numeric_limits<T>::is_iec559) {                             \
            if (x > 0) [[likely]] {                                                    \
                ...
                std23::assume(eBits > 0);                                              \
                std23::assume(eBits < 1 << k);                                         \
...
MACE_MATH_RA_N_LOG_DEFINITION(
    2, QinRational({1.59335600355316158862256902280174696L,
                   ...
                   x))
MACE_MATH_RA_N_LOG_DEFINITION(
    3, QinRational({2.35902031055879741771578914165316506L,
                   ...
                   x))
MACE_MATH_RA_N_LOG_DEFINITION(
    4, QinRational({3.42026643840447329823759184136547305L,
                   ...
                   x))
MACE_MATH_RA_N_LOG_DEFINITION(
    5, QinRational({4.91450165528015359869501472869497493L,
                   ...
                   x))
MACE_MATH_RA_N_LOG_DEFINITION(
    6, QinRational({7.02829409402350007790278087270308057L,
