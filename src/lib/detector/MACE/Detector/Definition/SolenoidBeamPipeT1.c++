...
auto SolenoidBeamPipeT1::Construct(G4bool checkOverlaps) -> void {
    ...
    const auto pipeName{beamPipe.Name() + "T1"};
    const auto solidPipe{Make<G4Torus>(
        pipeName,
        0,
    ...
    const auto solidVacuum{Make<G4Torus>(
        vacuumName,
        0,
