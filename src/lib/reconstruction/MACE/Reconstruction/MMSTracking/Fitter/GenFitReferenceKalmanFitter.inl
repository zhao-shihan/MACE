...
GenFitReferenceKalmanFitter<AHit, ATrack>::GenFitReferenceKalmanFitter(double driftErrorRMS) :
    GenFitterBase<AHit, ATrack, genfit::KalmanFitterRefTrack>{driftErrorRMS} {}
...
auto GenFitReferenceKalmanFitter<AHit, ATrack>::operator()(const std::vector<AHitPointer>& hitData, ASeedPointer seed) -> std::pair<std::shared_ptr<Mustard::Data::Tuple<ATrack>>,
