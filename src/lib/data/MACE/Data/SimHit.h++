...
using SimHitVertexTruth = Mustard::Data::TupleModel<Mustard::Data::Value<int, "TrkID", "MC Track ID">,
...
using CDCSimHit = Mustard::Data::TupleModel<CDCHit,
...
using TTCSimHit = Mustard::Data::TupleModel<TTCHit,
...
using MCPSimHit = Mustard::Data::TupleModel<MCPHit,
                             Mustard::Data::Value<float, "Edep", "Energy deposition">,
                             Mustard::Data::Value<float, "Ek", "Hit kinetic energy (MC truth)">,
                             Mustard::Data::Value<muc::array3f, "p", "Hit momentum (MC truth)">,
                             internal::SimHitVertexTruth>;

using EMCSimHit = Mustard::Data::TupleModel<EMCHit,
