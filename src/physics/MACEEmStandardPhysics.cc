...
#include "messenger/MACEPhysicsMessenger.hh"
...
G4_DECLARE_PHYSCONSTR_FACTORY(MACEEmStandardPhysics);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

MACEEmStandardPhysics::MACEEmStandardPhysics(G4int ver, const G4String&)
...
MACEEmStandardPhysics::~MACEEmStandardPhysics()
{
  delete fmessenger;
}


void MACEEmStandardPhysics::ConstructParticle()
{
  // gamma
  G4Gamma::Gamma();
  ...
  MACEMuoniumPlus::MuoniumDefinition();
...
void MACEEmStandardPhysics::ConstructProcess()
{
  fmessenger = new MACEPhysicsMessenger(this); 
  ...
  while( (*particleIterator)() ){
	...
	if( particleName == "mu+" )
	  pmanager->AddDiscreteProcess(new MACEMuFormation());
	} 

    else if (particleName=="Mu") {
      G4VProcess* aMuScatt = new MACEMuScatter();
...
void MACEEmStandardPhysics::SetMMCPhysics(G4double pof)
{
  if( pof <= 1.0 && pof >= 0.)
	{
	...
	MACEMuoniumPlus::MuoniumDefinition() -> SetDecayTable(MuoniumDecayTable);
	}
}


void MACEEmStandardPhysics::SetRDPhysics(G4double mbr)
{
  if( mbr <= 1.0 && mbr >= 0.)
	{
	G4DecayTable* MuonPlusDecayTable = new G4DecayTable();
	MuonPlusDecayTable -> Insert(new G4MuonDecayChannel("mu+",1.0-mbr) );
	MuonPlusDecayTable -> Insert(new MACEMuonDecayChannel("mu+",mbr) );// PDG: branch ratio = 3.4e-5
	G4MuonPlus::MuonPlusDefinition() -> SetDecayTable(MuonPlusDecayTable);
	}

}

void MACEEmStandardPhysics::SetMFPhysics(G4double mf)
{
