...
MACEMuoniumPlus* MACEMuoniumPlus::theInstance = 0;

MACEMuoniumPlus* MACEMuoniumPlus::Definition() {
    ...
    theInstance = reinterpret_cast<MACEMuoniumPlus*>(anInstance);

    return theInstance;
}

MACEMuoniumPlus* MACEMuoniumPlus::MuoniumDefinition() {
    return Definition();
}

MACEMuoniumPlus* MACEMuoniumPlus::Muonium() {
    return Definition();
}
