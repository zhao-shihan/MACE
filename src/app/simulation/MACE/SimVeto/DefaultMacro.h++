...
constexpr auto defaultMacro = {
    ...
    "/run/verbose 2",
    "",
    "#/Mustard/Detector/Description/Ixport SimVeto.yaml",
    "",
    "/run/initialize",
    "",
    "/Mustard/EcoMug/Position/HSphere 0 0 0 m",
    "/Mustard/EcoMug/Size/HSphere/Radius 2 m",
    "",
    ...
    "/vis/geometry/set/visibility VetoModuleBox_0                 0          no",
    "/vis/geometry/set/visibility VetoModuleBox_1                 0          no",
    "/vis/geometry/set/visibility VetoModuleBox_2                 0          no",
    "/vis/geometry/set/visibility VetoModuleBox_3                 0          no",
    "",
    "# Colors",
    "/vis/geometry/set/colour VetoFiberHole_0                       0     1     1     1       0.",
    "/vis/geometry/set/colour VetoFiberHole_1                       0     1     1     1       0.",
    "/vis/geometry/set/colour VetoFiberHole_2                       0     1     1     1       0.",
    "/vis/geometry/set/colour VetoFiberHole_3                       0     1     1     1       0.",
    "/vis/geometry/set/colour VetoFiberOuter_0                      0     0     1     0       0.1",
    "/vis/geometry/set/colour VetoFiberInner_0                      0     0     1     0       0.2",
    "/vis/geometry/set/colour VetoFiberCore_0                       0     0     1     0       0.3",
    "/vis/geometry/set/colour VetoFiberOuter_1                      0     0     1     0       0.1",
    "/vis/geometry/set/colour VetoFiberInner_1                      0     0     1     0       0.2",
    "/vis/geometry/set/colour VetoFiberCore_1                       0     0     1     0       0.3",
    "/vis/geometry/set/colour VetoFiberOuter_2                      0     0     1     0       0.1",
    "/vis/geometry/set/colour VetoFiberInner_2                      0     0     1     0       0.2",
    "/vis/geometry/set/colour VetoFiberCore_2                       0     0     1     0       0.3",
    "/vis/geometry/set/colour VetoFiberOuter_3                      0     0     1     0       0.1",
    "/vis/geometry/set/colour VetoFiberInner_3                      0     0     1     0       0.2",
    "/vis/geometry/set/colour VetoFiberCore_3                       0     0     1     0       0.3",
