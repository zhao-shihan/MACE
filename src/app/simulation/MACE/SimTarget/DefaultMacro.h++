...
constexpr auto defaultMacro = {
    ...
    "",
    "# I/O & Analysis",
    "/MACE/Analysis/ResultPath                          SimTarget_result",
    "/MACE/Analysis/EnableYieldAnalysis                    true",
    "",
    "# Geometry",
    "#/MACE/Detector/Description/Import                     geom.yaml",
    "/MACE/Detector/TargetDensity                       30 mg/cm3",
    "/MACE/Detector/TargetTemperature                   293.15 K",
    "",
    "# Initialize kernel",
    "/run/initialize",
    "",
    ...
    "/MACE/Generator/SurfaceMuon/PositionZ                -5 cm",
    "/MACE/Generator/SurfaceMuon/MuonsForEachG4Event    10",
    "",
    "# Set physics",
    "/MACE/Physics/MuoniumPhysics/Formation/FormationProbability     0.65",
