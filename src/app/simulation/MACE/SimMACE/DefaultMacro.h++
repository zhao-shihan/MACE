...
constexpr auto defaultMacro = {
    ...
    "/run/verbose 2",
    "",
    "/Mustard/Detector/Description/Ixport SimMACE.yaml",
    "",
    "/run/initialize",
    "",
    "/gps/particle             mu+",
    ...
    "/vis/geometry/set/visibility ECALMPPCCoupler      0 no",
    "/vis/geometry/set/visibility ECALPMCathode        0 no",
    "/vis/geometry/set/visibility ECALPMTCoupler       0 no",
    "/vis/geometry/set/visibility ECALPMTVacuum        0 no",
    ...
    "/vis/geometry/set/colour ECALPMTVacuum                 0     1     1     1     0.01",
    ...
    "/vis/geometry/set/colour VetoStripBox_0                0     1     1     1     0.005",
    "/vis/geometry/set/colour VetoStripBox_1                0     1     1     1     0.005",
    "/vis/geometry/set/colour VetoStripBox_2                0     1     1     1     0.005",
    "/vis/geometry/set/colour VetoStripBox_3                0     1     1     1     0.005",
    "/vis/geometry/set/colour VetoAlAbsorber_0              0     1     1     1     0.01",
    "/vis/geometry/set/colour VetoAlAbsorber_1              0     1     1     1     0.01",
    "/vis/geometry/set/colour VetoAlAbsorber_2              0     1     1     1     0.01",
    "/vis/geometry/set/colour VetoAlAbsorber_3              0     1     1     1     0.01",
    "",
    "/vis/scene/add/date",
