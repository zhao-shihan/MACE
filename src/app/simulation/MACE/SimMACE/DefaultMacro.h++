...
constexpr auto defaultMacro = {
    "#############################################################################",
    "#",
    "# Macro file demo for SimMACE in interactive session",
    "#",
    "#############################################################################",
    "",
    "#############################################################################",
    ...
    "/MACE/Generator/SurfaceMuon/TimeRMS                0 ns",
    "/MACE/Generator/SurfaceMuon/Momentum               28 MeV",
    "/MACE/Generator/SurfaceMuon/MomentumRMS            0.7 MeV",
    "/MACE/Generator/SurfaceMuon/PositionRMS            5 mm",
    "/MACE/Generator/SurfaceMuon/PositionZ              -1.5 m",
    "/MACE/Generator/SurfaceMuon/MuonsForEachG4Event    10",
    "",
    "/MACE/Physics/MuoniumPhysics/Formation/FormationProbability     0.6",
    "/MACE/Physics/MuoniumPhysics/Formation/ConversionProbability    0.5    # very high :) ",
    ...
    "",
    "/MACE/Analysis/CoincidenceWithCDC     true",
    "/MACE/Analysis/CoincidenceWithMCP     true",
    "/MACE/Analysis/CoincidenceWithEMC     true",
    "",
    "# Name of output",
    ...
    "/vis/geometry/set/colour CDCSenseLayer                 0     1     1     1     0.005",
    ...
    "/vis/geometry/set/colour Filter                        0     1     1     1     0.05",
    "/vis/geometry/set/colour MCP                           0     1     1     1     0.1",
    "/vis/geometry/set/colour ShieldingWall                 0     1     1     1     0.05",
    "/vis/geometry/set/colour SelectorField                 0     1     1     1     0.05",
    "/vis/geometry/set/colour SolenoidB1                    0     1     1     1     0.05",
    "/vis/geometry/set/colour SolenoidB1Field               0     1     1     1     0.05",
    "/vis/geometry/set/colour SolenoidB2                    0     1     1     1     0.05",
    "/vis/geometry/set/colour SolenoidB2Field               0     1     1     1     0.05",
    "/vis/geometry/set/colour SolenoidS1                    0     1     1     1     0.05",
    "/vis/geometry/set/colour SolenoidS1Field               0     1     1     1     0.05",
