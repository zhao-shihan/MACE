...
constexpr auto defaultMacro = {
    ...
    "/vis/geometry/set/visibility ECALField            0 no",
    ...
    "/vis/geometry/set/visibility SolenoidFieldS1      0 no",
    "/vis/geometry/set/visibility SolenoidFieldS2      0 no",
    ...
    "/vis/geometry/set/visibility cap2ModuleBox                -1          no",
    "/vis/geometry/set/visibility cap1ModuleBox                -1          no",
    "/vis/geometry/set/visibility topModuleBox                 -1          no",
    "/vis/geometry/set/visibility sideModuleBox                -1          no",
    "/vis/geometry/set/visibility Cap2StripBox                  0          yes",
    "/vis/geometry/set/visibility Cap1StripBox                  0          yes",
    "/vis/geometry/set/visibility TopStripBox                   0          yes",
    "/vis/geometry/set/visibility SideStripBox                  0          yes",
    "/vis/geometry/set/visibility VirtualPairBox                0          no",
    "/vis/geometry/set/visibility AlAbsorber                    0          yes",
    "",
    "# Colors",
    ...
    "/vis/geometry/set/colour Cap2StripBox                  0     0.7   0     0.3   0.1",
    "/vis/geometry/set/colour Cap1StripBox                  0     0     1     0     0.1",
    "/vis/geometry/set/colour TopStripBox                   0     1     0     0     0.1",
    "/vis/geometry/set/colour SideStripBox                  0     0     0     1     0.1",
    "/vis/geometry/set/colour AlAbsorber                    0     1     1     1     0.3",
