...
#include "MACE/PhaseI/Data/SimVertex.h++"
...
public:
    ...
    auto SubmitPrimaryVertexData(const std::vector<std::unique_ptr<Mustard::Data::Tuple<MACE::PhaseI::Data::SimPrimaryVertex>>>& data) -> void { fPrimaryVertex = &data; }
    auto SubmitDecayVertexData(const std::vector<std::unique_ptr<Mustard::Data::Tuple<MACE::PhaseI::Data::SimDecayVertex>>>& data) -> void { fDecayVertex = &data; }
...
private:
    ...
    std::optional<Mustard::Data::Output<MACE::PhaseI::Data::SimPrimaryVertex>> fPrimaryVertexOutput;
    std::optional<Mustard::Data::Output<MACE::PhaseI::Data::SimDecayVertex>> fDecayVertexOutput;
    std::optional<Mustard::Data::Output<MACE::PhaseI::Data::MRPCSimHit>> fMRPCSimHitOutput;
    std::optional<Mustard::Data::Output<MACE::PhaseI::Data::ECALSimHit>> fECALSimHitOutput;
    std::optional<Mustard::Data::Output<MACE::PhaseI::Data::ECALPMHit>> fECALPMHitOutput;
    ...
    const std::vector<std::unique_ptr<Mustard::Data::Tuple<MACE::PhaseI::Data::SimPrimaryVertex>>>* fPrimaryVertex;
    const std::vector<std::unique_ptr<Mustard::Data::Tuple<MACE::PhaseI::Data::SimDecayVertex>>>* fDecayVertex;
