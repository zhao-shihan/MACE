...
if(NOT MACE_BUILTIN_GENFIT)
    ...
    if(NOT genfit_FOUND)
        ...
        message(NOTICE "***Notice: GenFit not found (minimum required is ${MACE_GENFIT_MINIMUM_REQUIRED}). For the time turning on MACE_BUILTIN_GENFIT")
    endif()
endif()
...
if(MACE_BUILTIN_GENFIT)
    ...
    if(NOT EXISTS "${MACE_BUILTIN_GENFIT_SRC_DIR}/CMakeLists.txt")
        ...
        message(FATAL_ERROR "It seems that the download of GenFit has failed. You can try running cmake again, or manually download GenFit from ${MACE_BUILTIN_GENFIT_URL} and extract it to ${MACE_PROJECT_3RDPARTY_DIR} (and keep the directory structure). If the error persists, you can try cleaning the build tree and restarting the build.")
    endif()
endif()
