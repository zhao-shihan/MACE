...
if(MACE_BUILTIN_YAML_CPP)
    ...
    if(NOT MACE_BUILTIN_YAML_CPP_FOUND)
        ...
        mace_find_built_in_yaml_cpp(MACE_BUILTIN_YAML_CPP_FOUND MACE_BUILTIN_YAML_CPP_DIR MACE_BUILTIN_YAML_CPP_VERSION)
        if(NOT MACE_BUILTIN_YAML_CPP_FOUND)
            message(FATAL_ERROR "yaml-cpp still remains invalid, even after the download procedure. This may be caused by an incomplete download, or by a corrupted directory structure. You can try to clean the build tree, delete all yaml-cpp-yaml-cpp-* directories under ${MACE_PROJECT_3RDPARTY_DIR}, then re-run CMake. If the download always fails, you can manually download yaml-cpp from ${MACE_BUILTIN_YAML_CPP_ARCHIVE_SRC} and copy it to ${MACE_BUILTIN_YAML_CPP_ARCHIVE_DEST} (and keep the file name), or directly unpack it to ${MACE_PROJECT_3RDPARTY_DIR} (and keep the directory structure).")
        endif()
    endif()
    # report
...
if(NOT MACE_BUILTIN_YAML_CPP)
    ...
    message(STATUS "Looking for yaml-cpp - built-in")
endif()
