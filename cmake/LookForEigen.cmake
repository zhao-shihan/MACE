...
if(MACE_BUILTIN_EIGEN)
    ...
    set(MACE_BUILTIN_EIGEN_DIR "${MACE_PROJECT_3RDPARTY_DIR}/eigen-${MACE_BUILTIN_EIGEN_VERSION}")
    ...
    if(EXISTS "${MACE_BUILTIN_EIGEN_DIR}/CMakeLists.txt")
        message(STATUS "Reusing Eigen source ${MACE_BUILTIN_EIGEN_DIR}")
        FetchContent_Declare(Eigen3 SOURCE_DIR "${MACE_BUILTIN_EIGEN_DIR}")
    else()
        message(STATUS "Fetching Eigen from ${MACE_BUILTIN_EIGEN_URL} to ${MACE_BUILTIN_EIGEN_DIR}")
        FetchContent_Declare(Eigen3 SOURCE_DIR "${MACE_BUILTIN_EIGEN_DIR}"
                                    URL "${MACE_BUILTIN_EIGEN_URL}")
    endif()
    # configure it
    message(STATUS ">>>>>>>> Configuring built-in Eigen (version: ${MACE_BUILTIN_EIGEN_VERSION})")
    FetchContent_MakeAvailable(Eigen3)
    message(STATUS "<<<<<<<< Configuring built-in Eigen (version: ${MACE_BUILTIN_EIGEN_VERSION}) - done")
endif()
