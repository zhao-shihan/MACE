...
if(MACESW_CLANG_TIDY)
    ...
    if(MACESW_UNITY_BUILD)
        message(SEND_ERROR "clang-tidy may generate false positives when using unity build. Try disable unity build (MACESW_UNITY_BUILD=OFF) to perform code analysis.")
    endif()
else()
    message(WARNING "MACESW source code will not be analysed by clang-tidy")
endif()
