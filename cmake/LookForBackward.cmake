...
if(NOT MACE_BUILTIN_BACKWARD)
    find_package(Backward "${MACE_BACKWARD_MINIMUM_REQUIRED}.0" QUIET)
    if(NOT Backward_FOUND)
        set(MACE_BUILTIN_BACKWARD ON)
        message(NOTICE "***Notice: backward-cpp not found (minimum required is ${MACE_BACKWARD_MINIMUM_REQUIRED}). Turning on MACE_BUILTIN_BACKWARD")
    endif()
endif()
...
if(NOT MACE_BUILTIN_BACKWARD)
    message(STATUS "Looking for backward-cpp - found (version: ${Backward_VERSION})")
else()
