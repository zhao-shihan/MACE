...
if(MACE_BUILTIN_MUSTARD)
    ...
    # set options
    set(MUSTARD_USE_G4VIS ${MACE_USE_G4VIS} CACHE INTERNAL "")
    # set(MUSTARD_USE_STATIC_G4 ${MACE_USE_STATIC_G4} CACHE INTERNAL "")
    ...
    set(MUSTARD_ENABLE_MSVC_STD_CONFORMITY ${MACE_ENABLE_MSVC_STD_CONFORMITY} CACHE INTERNAL "")
    ...
    if(NOT EXISTS "${MACE_BUILTIN_MUSTARD_SRC_DIR}/CMakeLists.txt")
        ...
        message(FATAL_ERROR "It seems that the download of Mustard is not successful. You can try to run cmake again, or manually download Mustard from ${MACE_BUILTIN_MUSTARD_URL} and extract it to ${MACE_PROJECT_3RDPARTY_DIR} (and keep the directory structure). If the error persists, you can try to clean the build tree and restart the build.")
    endif()
endif()
