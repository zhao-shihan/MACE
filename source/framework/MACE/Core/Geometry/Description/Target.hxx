...
public:
    ...
    bool Contains(const R3VectorSpace auto& x, bool insideVolume) const noexcept;
...
private:
    ...
    private:
        ...
        public:
            ...
            bool TestDetailedShape(const R3VectorSpace auto& x) const noexcept;
            bool TestDetailedDetectable(const R3VectorSpace auto&) const noexcept { return false; }
