...
AEntity& EntityBase::NewDaughter(G4bool checkOverlaps) {
...
template<std::derived_from<EntityBase> AEntity>
std::optional<std::reference_wrapper<AEntity>> EntityBase::FindDaughter() const {
...
void EntityBase::RegisterField(gsl::index volumeIndex, gsl::not_null<AField*> field, G4double hMin, G4int nVarStepper, G4int nVarDriver, G4bool propagateToDescendants) const {
...
template<std::derived_from<G4Field> AField, std::derived_from<G4EquationOfMotion> AEquation, class AStepper, std::derived_from<G4VIntegrationDriver> ADriver>
void EntityBase::RegisterField(gsl::not_null<AField*> field, G4double hMin, G4int nVarStepper, G4int nVarDriver, G4bool propagateToDescendants) const {
...
ASolid* EntityBase::Make(auto&&... args) {
...
ALogical* EntityBase::Make(auto&&... args) {
...
APhysical* EntityBase::Make(auto&&... args) {
