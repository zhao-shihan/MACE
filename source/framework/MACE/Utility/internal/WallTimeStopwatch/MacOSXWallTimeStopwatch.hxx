...
public:
    ...
    ~WallTimeStopwatch() noexcept { mach_port_deallocate(mach_task_self(), fSystemClock); }
...
#include "MACE/Utility/internal/WallTimeStopwatch/MacOSXWallTimeStopwatch.inl"
