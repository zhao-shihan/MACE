...
public:
    ...
    constexpr void operator()(ATupleCVRef&& tuple, AFunctor&& func) const { // clang-format on
...
constexpr void TupleForEach(const AATuple<AElement...>& tuple, AFunctor&& func) {
    Detail::TupleForEach<AATuple, AFunctor, AElement...>()(tuple, std::forward<AFunctor>(func));
}
