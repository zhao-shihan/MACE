...
MACE_UTILITY_LITERAL_UNIT_DEFINITION(mT, 1e-3 * CLHEP::tesla)
MACE_UTILITY_LITERAL_UNIT_DEFINITION(uT, 1e-6 * CLHEP::tesla)
...
MACE_UTILITY_LITERAL_UNIT_DEFINITION(mH, 1e-3 * CLHEP::henry)
MACE_UTILITY_LITERAL_UNIT_DEFINITION(uH, 1e-6 * CLHEP::henry)
MACE_UTILITY_LITERAL_UNIT_DEFINITION(nH, 1e-9 * CLHEP::henry)
