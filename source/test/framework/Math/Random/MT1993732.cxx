...
int main() {
    ...
    time = timer.MillisecondsElapsed();
    std::cout << "       std::mt19937 : " << time << " ms (last displacement: " << v2d << ')' << std::endl;
    ...
    time = timer.MillisecondsElapsed();
    std::cout << "    MACE MT19937-32 : " << time << " ms (last displacement: " << v2d << ')' << std::endl;
    ...
    time = timer.MillisecondsElapsed();
    std::cout << "       std::mt19937 : " << time << " ms (last displacement: " << v3d << ')' << std::endl;
    ...
    time = timer.MillisecondsElapsed();
    std::cout << "    MACE MT19937-32 : " << time << " ms (last displacement: " << v3d << ')' << std::endl;
    ...
    time = timer.MillisecondsElapsed();
    std::cout << "       std::mt19937 : " << time << " ms (last displacement: " << v4d << ')' << std::endl;
    ...
    time = timer.MillisecondsElapsed();
    std::cout << "    MACE MT19937-32 : " << time << " ms (last displacement: " << v4d << ')' << std::endl;
