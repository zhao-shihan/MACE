        ...
        node, [this](auto&& shape) {
            if (shape == "Cuboid") {
                ...
                MACE_ENVIRONMENT_CONTROLLED_OUT(Warning, std::cout)
                    << "MACE::Geometry::Description::Target::ImportValues: Unknown target shape \"" << shape << "\", skipping" << std::endl;
            }
        },
        "ShapeType");
    {
        ...
        ImportValue<std::string>(
            node, [this](auto&& detail) {
                if (detail == "Flat") {
                    ...
                    MACE_ENVIRONMENT_CONTROLLED_OUT(Warning, std::cout)
                        << "MACE::Geometry::Description::Target::ImportValues: Unknown cuboid target detail \"" << detail << "\", skipping" << std::endl;
                }
            },
            "Cuboid", "DetailType");
        {
