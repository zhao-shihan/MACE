...
MACE::ReconTracks::Tracker::Hough<FitterT_t, CDCHit_t>::
...
template<template<class T> class FitterT_t, class CDCHit_t>
void MACE::ReconTracks::Tracker::Hough<FitterT_t, CDCHit_t>::
...
FitAndDumpToResult(const HelixParameters& parameters, const std::vector<HitPtr*>* track) {
    ...
    for (auto&& hitPtr : fittedTrack) {
        hitPtrMap[hitPtr]->reset(static_cast<CDCHit_t*>(nullptr));
    }
}
