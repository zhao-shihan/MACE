...
public:
    ...
    virtual void CreateBranch(TTree& tree) { tree.Branch(fBranchName, std::addressof(fValue)); }
    virtual void ConnectToBranch(TTree& tree) { tree.SetBranchAddress(fBranchName, std::addressof(fValue)); }
