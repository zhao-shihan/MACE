...
int main() {
    ...
    Math::Random::Xoshiro512MM xoshiro512MM;
    ...
    for (int i = 0; i < 1000; ++i) { r = xoshiro512MM(); }
    stopWatch.Reset();
    for (int i = 0; i < 10'000'000; ++i) { r = xoshiro512MM(); }
    ...
    for (int i = 0; i < 1000; ++i) { std::ranges::shuffle(arr16, xoshiro512MM); }
    stopWatch.Reset();
    for (int i = 0; i < 1'000'000; ++i) { std::ranges::shuffle(arr16, xoshiro512MM); }
    time = stopWatch.MillisecondsElapsed();
    ...
    for (int i = 0; i < 100; ++i) { std::ranges::shuffle(arr4096, xoshiro512MM); }
    stopWatch.Reset();
    for (int i = 0; i < 10'000; ++i) { std::ranges::shuffle(arr4096, xoshiro512MM); }
    time = stopWatch.MillisecondsElapsed();
    ...
    v2d = {0, 0};
    for (int i = 0; i < 1'000'000; ++i) {
        delta2d = {Math::Random::Uniform<double>()(xoshiro512MM),
                   Math::Random::Uniform<double>()(xoshiro512MM)};
        v2d += delta2d;
    }
    stopWatch.Reset();
    for (int i = 0; i < 10'000'000; ++i) {
    ...
    v3d = {0, 0, 0};
    for (int i = 0; i < 1'000'000; ++i) {
        delta3d = {Math::Random::Uniform<double>()(xoshiro512MM),
                   Math::Random::Uniform<double>()(xoshiro512MM),
                   Math::Random::Uniform<double>()(xoshiro512MM)};
        v3d += delta3d;
    }
    ...
    v4d = {0, 0, 0, 0};
    for (int i = 0; i < 1'000'000; ++i) {
        delta4d = {Math::Random::Uniform<double>()(xoshiro512MM),
                   Math::Random::Uniform<double>()(xoshiro512MM),
                   Math::Random::Uniform<double>()(xoshiro512MM),
                   Math::Random::Uniform<double>()(xoshiro512MM)};
        v4d += delta4d;
