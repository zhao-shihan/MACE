...
int main() {
    ...
    Generator::Xoshiro256Plus xoshiro256p;
    ...
    for (int i = 0; i < 1000; ++i) { std::ranges::shuffle(arr16, xoshiro256p); }
    timer.Reset();
    for (int i = 0; i < 1'000'000; ++i) { std::ranges::shuffle(arr16, xoshiro256p); }
    time = timer.MillisecondsElapsed();
    ...
    for (int i = 0; i < 100; ++i) { std::ranges::shuffle(arr4096, xoshiro256p); }
    timer.Reset();
    for (int i = 0; i < 10'000; ++i) { std::ranges::shuffle(arr4096, xoshiro256p); }
    time = timer.MillisecondsElapsed();
    ...
    v2d = {0, 0};
    for (int i = 0; i < 1'000'000; ++i) {
        delta2d = {Distribution::Uniform<double>()(xoshiro256p),
                   Distribution::Uniform<double>()(xoshiro256p)};
        v2d += delta2d;
    }
    timer.Reset();
    for (int i = 0; i < 10'000'000; ++i) {
    ...
    v3d = {0, 0, 0};
    for (int i = 0; i < 1'000'000; ++i) {
        delta3d = {Distribution::Uniform<double>()(xoshiro256p),
                   Distribution::Uniform<double>()(xoshiro256p),
                   Distribution::Uniform<double>()(xoshiro256p)};
        v3d += delta3d;
    }
    ...
    v4d = {0, 0, 0, 0};
    for (int i = 0; i < 1'000'000; ++i) {
        delta4d = {Distribution::Uniform<double>()(xoshiro256p),
                   Distribution::Uniform<double>()(xoshiro256p),
                   Distribution::Uniform<double>()(xoshiro256p),
                   Distribution::Uniform<double>()(xoshiro256p)};
        v4d += delta4d;
