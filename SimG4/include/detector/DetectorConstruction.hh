...
private:
    ...
    Geometry::FirstBendField* const             fFirstBendField;
    Geometry::FirstTransportField* const        fFirstTransportField;
    ...
    Geometry::SecondBendField* const            fSecondBendField;
    Geometry::SecondTransportField* const       fSecondTransportField;
    Geometry::SelectorField* const              fSelectorField;
    Geometry::Spectrometer* const               fSpectrometer;
    Geometry::SpectrometerField* const          fSpectrometerField;
    ...
    Geometry::ThirdTransportField* const        fThirdTransportField;
