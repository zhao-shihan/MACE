...
void Analysis::Fill() const {
    ...
    for (const auto* const hit : *calorimeterHits) {
        ...
        fpG4Analysis->FillNtupleSColumn(ntupleID, 4, hit->ParticleName());
    ...
    for (const auto* const hit : *orbitalDetectorHits) {
        ...
        fpG4Analysis->FillNtupleIColumn(ntupleID, 1, hit->TrackID());
        fpG4Analysis->FillNtupleFColumn(ntupleID, 2, hit->HitTime());
        fpG4Analysis->FillNtupleFColumn(ntupleID, 3, hit->HitPosition().x());
        fpG4Analysis->FillNtupleFColumn(ntupleID, 4, hit->HitPosition().y());
        fpG4Analysis->FillNtupleFColumn(ntupleID, 5, hit->HitPosition().z());
        fpG4Analysis->FillNtupleFColumn(ntupleID, 6, hit->VertexTime());
        fpG4Analysis->FillNtupleFColumn(ntupleID, 7, hit->VertexPosition().x());
        fpG4Analysis->FillNtupleFColumn(ntupleID, 8, hit->VertexPosition().y());
        fpG4Analysis->FillNtupleFColumn(ntupleID, 9, hit->VertexPosition().z());
        fpG4Analysis->FillNtupleSColumn(ntupleID, 10, hit->ParticleName());
        fpG4Analysis->AddNtupleRow(ntupleID);
    }
    ...
    for (const auto* const hit : *spectrometerHits) {
        ...
        fpG4Analysis->FillNtupleFColumn(ntupleID, 3, hit->HitTime());
        fpG4Analysis->FillNtupleFColumn(ntupleID, 4, hit->HitPosition().x());
        fpG4Analysis->FillNtupleFColumn(ntupleID, 5, hit->HitPosition().y());
        fpG4Analysis->FillNtupleFColumn(ntupleID, 6, hit->HitPosition().z());
        fpG4Analysis->FillNtupleFColumn(ntupleID, 7, hit->VertexTime());
        fpG4Analysis->FillNtupleFColumn(ntupleID, 8, hit->VertexPosition().x());
        fpG4Analysis->FillNtupleFColumn(ntupleID, 9, hit->VertexPosition().y());
        fpG4Analysis->FillNtupleFColumn(ntupleID, 10, hit->VertexPosition().z());
        fpG4Analysis->FillNtupleSColumn(ntupleID, 11, hit->ParticleName());
        fpG4Analysis->AddNtupleRow(ntupleID);
    }
}
