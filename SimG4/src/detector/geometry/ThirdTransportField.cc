...
MACE::SimG4::Geometry::ThirdTransportField::ThirdTransportField() :
    MACE::SimG4::Geometry::BaseInterface(1) {}

void MACE::SimG4::Geometry::ThirdTransportField::Create(G4Material* material, const BaseInterface* mother) {
    G4String name("ThirdTransportField");
