...
MACE::SimG4::Geometry::ParallelTransportField::ParallelTransportField() :
    MACE::SimG4::Geometry::BaseInterface(1) {}

void MACE::SimG4::Geometry::ParallelTransportField::Create(G4Material* material, const BaseInterface* mother) {
