...
#include "Geometry/Description/DescendantsOfWorld/SecondTransportField.hh"
...
class MACE::Geometry::Entity::Fast::SecondTransportField final :
    ...
    void ConstructSelf() override {
        ...
        auto physic = new G4PVPlacement(G4Transform3D(G4RotationMatrix(G4ThreeVector(0.0, 1.0, 0.0), M_PI_2), G4ThreeVector(upXPosition + 0.5 * length, 0.0, centerZ)), name, logic, MotherVolume(), false, 0, fgCheckOverlaps);
