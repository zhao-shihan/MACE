...
class MACE::Geometry::Entity::Fast::SecondBendField final :
    ...
    void CreateSelf() override {
        ...
        auto physic = new G4PVPlacement(G4Transform3D(G4RotationMatrix(G4ThreeVector(1.0, 0.0, 0.0), M_PI_2), G4ThreeVector(xPosition, 0.0, xPosition)), name, logic, MotherVolume(), false, 0, fgCheckOverlaps);
