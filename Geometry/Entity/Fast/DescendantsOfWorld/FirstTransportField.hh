...
#include "Geometry/Description/DescendantsOfWorld/FirstTransportField.hh"
...
class MACE::Geometry::Entity::Fast::FirstTransportField final :
    ...
    void ConstructSelf() override {
        ...
        auto physic = new G4PVPlacement(nullptr, G4ThreeVector(0, 0, upZPosition + 0.5 * length), name, logic, MotherVolume(), false, 0, fgCheckOverlaps);
